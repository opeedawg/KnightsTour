...
{
    [TestClass]
    public class SQLServerTestsBase : SQLServerTestSupport 
    {
        ...
        {
            SQLServerTestSupport .ClassInit(context);
        }
        /// <summary>
        ...
        {
            SQLServerTestSupport .ClassCleanup();
        }
        #endregion
        ...
        {
            ResetTestTableData();
            SQLServerStorageHandler handler = (SQLServerStorageHandler)StorageProvider.GetHandler();
        ...
        public void Handler_GetValue()
        {
            ...
            int recordCount = handler.GetValue<int>(statement);
            Assert.IsTrue(recordCount > 0);
        }
        [TestMethod]
        ...
        public void Handler_Execute_Update()
        {
            ...
            statement =  new KnightsTour.CoreLibrary.StorageStatement
            {
                Statement = $"SELECT Top(1) TestTable1Id, Name FROM {StorageProvider.GetTableSQL("TestTable1")} ORDER BY TestTable1Id DESC"
            };
