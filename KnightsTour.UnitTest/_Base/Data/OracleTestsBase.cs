...
{
    [TestClass]
    public class OracleTestsBase : OracleTestSupport
    {
        ...
        {
            OracleTestSupport.ClassInit(context);
        }
        /// <summary>
        ...
        {
            OracleTestSupport.ClassCleanup();
        }
        #endregion
        ...
        public void Handler_RetrievalCondition_Order_DESC()
        {
            ...
            decimal lastFKId = decimal.MaxValue;
            foreach (IDataRecord record in handler.GetRecords(statement))
            {
                Assert.IsTrue(record.FieldCount > 0);
                decimal newFKId = record.ValueAs<decimal>("TestTable2Id");
        ...
        public void Handler_GetRecord()
        {
            ...
            Assert.AreEqual(record.ValueAs<decimal>("TestTable1Id"), 4);
        }
        [TestMethod]
        public void Handler_GetDataSet()
        {
            ResetTestTableData();
            OracleStorageHandler handler = (OracleStorageHandler)StorageProvider.GetHandler();
        ...
        public void Handler_GetValue()
        {
            ...
            decimal recordCount = handler.GetValue<decimal>(statement);
            Assert.IsTrue(recordCount > 0);
        }
        [TestMethod]
        ...
        public void Handler_Execute_Delete()
        {
            ...
            int modifiedCount = handler.Execute(statement);
        ...
        public void Handler_Execute_Update()
        {
            ...
            statement = new KnightsTour.CoreLibrary.StorageStatement
            {
                Statement = $"SELECT \"TestTable1Id\", \"Name\" FROM {StorageProvider.GetTableSQL("TestTable1")} WHERE ROWNUM <= 1 ORDER BY \"TestTable1Id\" DESC"
            };
            DataRow row = handler.GetRecord(statement);
            decimal id = row.ValueAs<decimal>("TestTable1Id");
