/**
 * File:     EventType.store.ts
 * Location: src\entities\EventType\stores\
 * Store to implement any custom Event type api calls.  Mainly used to decorate service return calls.
 * 
...
import { EventTypeBaseStore } from './EventTypeBase.store';

/**
* Class: EventTypeStore
* @extends {EventTypeBaseStore}
*
* Class to implement any decoration on data returned from the api service endpoints.
*
* @implements {constructor} The constructor for the @see EventTypeStore class
* @implements {getAll} Performs any filtering, ordering or decoration of @see EventTypes.
...
*/
export class EventTypeStore extends EventTypeBaseStore {

  /**
  * Function [constructor]: 
  * The constructor for the @see EventTypeStore class
  */
  constructor() {
      super();
  } // constructor
  ...
  /**
  * Function [getAll]: 
  * Performs any filtering, ordering or decoration of @see EventTypes.
  * @returns {Promise<EventType[]>} A promise of an array of @see EventType
  */
