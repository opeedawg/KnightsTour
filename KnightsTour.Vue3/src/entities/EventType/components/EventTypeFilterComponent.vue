<!--
* Component: EventTypeFilterComponent
* Location:  src\entities\EventType\components\
* 
* Renders filter fields related to the @see EventType class.
* - Note: The filter fields are configured in @see EventTypeConfig class.
* 
...
export default {
  ...
  props: {
    /** The collection of @see EventType to filter. */
    entities: {
  ...
  methods: {
    ...
    * @param {EventTypePropertyNames} property: The property name for which to retrieve the attribute settings.
