<!--
* Component: EventHistoryFieldsComponent
* Location:  src\entities\EventHistory\components\
* 
* Renders fields related to the @see EventHistory class.
* - Note: fields are rendered based on rules defined in the @see EventHistoryConfig class.
* 
...
<template>
  ...
  >
    ...
    <q-card-section class="q-pt-none">
  	   ...
  	   <TextField v-if="fieldsLoaded" v-bind="attr_EventHistoryId"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_SourceInternetAddress"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_Country"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_Region"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_City"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_ZipPostal"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_Context"></TextField>
    </q-card-section>
  </q-card>
  <q-card
  ...
  >
    ...
    <q-card-section class="q-pt-none">
  	   <SelectField v-if="fieldsLoaded" v-bind="attr_EventTypeId"></SelectField>
    </q-card-section>
  </q-card>
  <q-card
...
<script lang="ts">
  ...
  import { EventHistoryDBFields } from '../models/base/EventHistoryConfigBase';
  import { EventHistoryPropertyNames } from '../models/base/EventHistoryBase';
  import { 
    FieldConfiguration,
    FieldSupport,
  } from 'src/common/models/fieldConfiguration';
  import { fieldConfigurations } from '../models/EventHistoryConfig';
...
*/
export default {
  Name: 'EventHistoryFieldsComponent',
  ...
  data: function () {
    return {
      ...
      eventHistoryPropertyNames: EventHistoryPropertyNames,
      /** Field configurations for the @see EventHistory. */
      fieldConfigurations,
  ...
  computed: {
    /**
    * Computed function [attr_City] for variable attr_City: 
    * - Assigns the attribute collection for the City property for field binding.
    * @returns {any} Anything
    */
    attr_City: function attr_City(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.city);
    }, // attr_City

    /**
    * Computed function [attr_Context] for variable attr_Context: 
    * - Assigns the attribute collection for the Context property for field binding.
    * @returns {any} Anything
    */
    attr_Context: function attr_Context(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.context);
    }, // attr_Context

    /**
    * Computed function [attr_Country] for variable attr_Country: 
    * - Assigns the attribute collection for the Country property for field binding.
    * @returns {any} Anything
    */
    attr_Country: function attr_Country(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.country);
    }, // attr_Country

    /**
    * Computed function [attr_EventHistoryId] for variable attr_EventHistoryId: 
    * - Assigns the attribute collection for the EventHistoryId property for field binding.
    * @returns {any} Anything
    */
    attr_EventHistoryId: function attr_EventHistoryId(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.eventHistoryId);
    }, // attr_EventHistoryId
    ...
    */
    attr_EventTypeId: function attr_EventTypeId(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.eventTypeId);
    }, // attr_EventTypeId
    ...
    */
    attr_InstanceLabel: function attr_InstanceLabel(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.instanceLabel);
    }, // attr_InstanceLabel

    /**
    * Computed function [attr_Region] for variable attr_Region: 
    * - Assigns the attribute collection for the Region property for field binding.
    * @returns {any} Anything
    */
    attr_Region: function attr_Region(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.region);
    }, // attr_Region

    /**
    * Computed function [attr_SourceInternetAddress] for variable attr_SourceInternetAddress: 
    * - Assigns the attribute collection for the SourceInternetAddress property for field binding.
    * @returns {any} Anything
    */
    attr_SourceInternetAddress: function attr_SourceInternetAddress(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.sourceInternetAddress);
    }, // attr_SourceInternetAddress

    /**
    * Computed function [attr_ZipPostal] for variable attr_ZipPostal: 
    * - Assigns the attribute collection for the ZipPostal property for field binding.
    * @returns {any} Anything
    */
    attr_ZipPostal: function attr_ZipPostal(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.eventHistoryPropertyNames.zipPostal);
    }, // attr_ZipPostal
  ...
  methods: {
    ...
    * @returns {EventHistory} @see EventHistory
    */
    collectFormData: function (): EventHistory {
      var updatedEntity = new EventHistory();
      let self = this;

      this.fieldSupport.updateEntity(
        updatedEntity,
        EventHistoryDBFields,
