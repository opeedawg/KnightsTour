 ...
 * The entity settings for the Board class that stay in sync with the DXterity model.
 * 
...
*
* Class to define all the possible entity settings for the Board class.  Stays in sync with the model on regeneration.  Add or overwrite in @see EntitySettings.
*
