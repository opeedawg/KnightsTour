 ...
 * Store to implement any custom Board api calls.  Mainly used to decorate service return calls.
 * 
...
import { BoardBaseStore } from './BoardBase.store';

/**
* Class: BoardStore
* @extends {BoardBaseStore}
*
* Class to implement any decoration on data returned from the api service endpoints.
*
* @implements {constructor} The constructor for the @see BoardStore class
* @implements {getAll} Performs any filtering, ordering or decoration of @see Boards.
...
*/
export class BoardStore extends BoardBaseStore {

  /**
  * Function [constructor]: 
  * The constructor for the @see BoardStore class
  */
  constructor() {
      super();
  } // constructor
  ...
  /**
  * Function [getAll]: 
  * Performs any filtering, ordering or decoration of @see Boards.
  * @returns {Promise<Board[]>} A promise of an array of @see Board
  */
