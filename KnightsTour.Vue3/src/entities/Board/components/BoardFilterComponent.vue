...
* 
* Renders filter fields related to the @see Board class.
* - Note: The filter fields are configured in @see BoardConfig class.
* 
...
export default {
  ...
  props: {
    /** The collection of @see Board to filter. */
    entities: {
  ...
  methods: {
    ...
    * @param {BoardPropertyNames} property: The property name for which to retrieve the attribute settings.
    * @returns {any} Dynamic object of attributes to bind to the control.
    */
    getAttribute: function (
      property: BoardPropertyNames
    ): any {
      let self = this;
      return {
