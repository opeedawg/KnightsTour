...
* 
* The page displayed inserting a new @see Board.
    ...
    */
    processFieldsAction: function (
      ...
      if (args.action == this.projectSettings.insertActionName) {
        try {
          this.boardStore.insert(args.data).then((response) => {
            if (response.isValid) {
              ...
              let postInsertRoute:any = {
                name: 'Board' + this.entitySettings.navigationAfterInsert,
              };
              ...
              if (
                ...
                postInsertRoute['params'] = { id: (<Board>response.dataObject).boardId };
              }
