<!--
* Component: PuzzleFilterComponent
* Location:  src\entities\Puzzle\components\
* 
* Renders filter fields related to the @see Puzzle class.
* - Note: The filter fields are configured in @see PuzzleConfig class.
* 
...
export default {
  ...
  props: {
    /** The collection of @see Puzzle to filter. */
    entities: {
  ...
  methods: {
    ...
    * @param {PuzzlePropertyNames} property: The property name for which to retrieve the attribute settings.
    * @returns {any} Dynamic object of attributes to bind to the control.
    */
    getAttribute: function (
      property: PuzzlePropertyNames
    ): any {
      let self = this;
      return {
