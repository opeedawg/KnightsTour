<!--
* Component: PuzzleFieldsComponent
* Location:  src\entities\Puzzle\components\
* 
* Renders fields related to the @see Puzzle class.
* - Note: fields are rendered based on rules defined in the @see PuzzleConfig class.
* 
...
<template>
  ...
  >
    ...
    <q-card-section class="q-pt-none">
  	   ...
  	   <TextField v-if="fieldsLoaded" v-bind="attr_PuzzleId"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_PuzzleCode"></TextField>
  ...
  >
    ...
    <q-card-section class="q-pt-none">
  	   <SelectField v-if="fieldsLoaded" v-bind="attr_BoardId"></SelectField>
  	   <SelectField v-if="fieldsLoaded" v-bind="attr_DifficultyLevelId"></SelectField>
    </q-card-section>
  </q-card>
  <q-card
  ...
  >
    ...
    <q-card-section class="q-pt-none">
  	   <DateField v-if="fieldsLoaded" v-bind="attr_PuzzleOfTheDayDate"></DateField>
      <DateField v-if="fieldsLoaded" v-bind="attr_PuzzleOfTheDayDateFormatted"></DateField>
    </q-card-section>
  </q-card>
  <q-card
...
<script lang="ts">
  ...
  import { fieldConfigurations } from '../models/PuzzleConfig';
  ...
  import { PuzzleDBFields } from '../models/base/PuzzleConfigBase';
  import { PuzzlePropertyNames } from '../models/base/PuzzleBase';
  import { 
    QDataType,
    QSelectOption,
...
export default {
  ...
  data: function () {
    return {
      ...
      dateFieldCount: 0,
      /** Field configurations for the @see Puzzle. */
      fieldConfigurations,
      ...
      puzzlePropertyNames: PuzzlePropertyNames,
  ...
  computed: {
    ...
    */
    attr_BoardId: function attr_BoardId(): any {
      ...
      return this.getAttribute(this.puzzlePropertyNames.boardId);
    }, // attr_BoardId
    ...
    */
    attr_DifficultyLevelId: function attr_DifficultyLevelId(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.puzzlePropertyNames.difficultyLevelId);
    ...
    */
    attr_InstanceLabel: function attr_InstanceLabel(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.puzzlePropertyNames.instanceLabel);
    }, // attr_InstanceLabel
    ...
    */
    attr_Path: function attr_Path(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.puzzlePropertyNames.path);
    }, // attr_Path

    /**
    * Computed function [attr_PuzzleCode] for variable attr_PuzzleCode: 
    * - Assigns the attribute collection for the PuzzleCode property for field binding.
    * @returns {any} Anything
    */
    attr_PuzzleCode: function attr_PuzzleCode(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.puzzlePropertyNames.puzzleCode);
    }, // attr_PuzzleCode
    ...
    */
    attr_PuzzleId: function attr_PuzzleId(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.puzzlePropertyNames.puzzleId);
    }, // attr_PuzzleId

    /**
    * Computed function [attr_PuzzleOfTheDayDate] for variable attr_PuzzleOfTheDayDate: 
    * - Assigns the attribute collection for the PuzzleOfTheDayDate property for field binding.
    * @returns {any} Anything
    */
    attr_PuzzleOfTheDayDate: function attr_PuzzleOfTheDayDate(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.puzzlePropertyNames.puzzleOfTheDayDate);
    }, // attr_PuzzleOfTheDayDate
  ...
  methods: {
    ...
    * @returns {Puzzle} @see Puzzle
    */
    collectFormData: function (): Puzzle {
      var updatedEntity = new Puzzle();
      let self = this;
