          ...
          <table width="100%">
            <tr>
              ...
              <td id="table_filters" text-align="left">
                ...
                <SolutionFilterComponent v-if="false" :entities="rows" />
              </td>
              <td
...
<script lang="ts">
  ...
  import SolutionFilterComponent from '../components/SolutionFilterComponent.vue';
