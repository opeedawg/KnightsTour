<!--
* Component: SolutionFilterComponent
* Location:  src\entities\Solution\components\
* 
* Renders filter fields related to the @see Solution class.
* - Note: The filter fields are configured in @see SolutionConfig class.
* 
...
export default {
  ...
  props: {
    /** The collection of @see Solution to filter. */
    entities: {
  ...
  methods: {
    ...
    * @param {SolutionPropertyNames} property: The property name for which to retrieve the attribute settings.
