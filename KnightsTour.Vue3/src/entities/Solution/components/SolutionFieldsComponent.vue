...
<template>
  ...
  >
    ...
    <q-card-section class="q-pt-none">
  	   <DateField v-if="fieldsLoaded" v-bind="attr_SolutionDate"></DateField>
      <DateField v-if="fieldsLoaded" v-bind="attr_SolutionDateFormatted"></DateField>
    </q-card-section>
  </q-card>
  <q-card
...
export default {
  ...
  computed: {
    ...
    */
    ...
    /**
    * Computed function [attr_SolutionDate] for variable attr_SolutionDate: 
    * - Assigns the attribute collection for the SolutionDate property for field binding.
    * @returns {any} Anything
    */
    attr_SolutionDate: function attr_SolutionDate(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.solutionPropertyNames.solutionDate);
    }, // attr_SolutionDate
    ...
    */
    attr_UserInitials: function attr_UserInitials(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.solutionPropertyNames.userInitials);
    }, // attr_UserInitials
  ...
  methods: {
    ...
    */
    collectFormData: function (): Solution {
      var updatedEntity = new Solution();
      let self = this;
