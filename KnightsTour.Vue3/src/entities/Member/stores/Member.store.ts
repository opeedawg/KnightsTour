/**
 * File:     Member.store.ts
 * Location: src\entities\Member\stores\
 * Store to implement any custom Member api calls.  Mainly used to decorate service return calls.
 * 
...
import { MemberBaseStore } from './MemberBase.store';

/**
* Class: MemberStore
* @extends {MemberBaseStore}
*
* Class to implement any decoration on data returned from the api service endpoints.
*
* @implements {constructor} The constructor for the @see MemberStore class
* @implements {getAll} Performs any filtering, ordering or decoration of @see Members.
...
*/
export class MemberStore extends MemberBaseStore {

  /**
  * Function [constructor]: 
  * The constructor for the @see MemberStore class
  */
  constructor() {
      super();
  } // constructor
  ...
  /**
  * Function [getAll]: 
  * Performs any filtering, ordering or decoration of @see Members.
  * @returns {Promise<Member[]>} A promise of an array of @see Member
  */
