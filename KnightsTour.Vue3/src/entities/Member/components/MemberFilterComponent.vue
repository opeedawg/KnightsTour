<!--
* Component: MemberFilterComponent
* Location:  src\entities\Member\components\
* 
* Renders filter fields related to the @see Member class.
* - Note: The filter fields are configured in @see MemberConfig class.
* 
...
export default {
  ...
  props: {
    /** The collection of @see Member to filter. */
    entities: {
  ...
  methods: {
    ...
    * @param {MemberPropertyNames} property: The property name for which to retrieve the attribute settings.
    * @returns {any} Dynamic object of attributes to bind to the control.
    */
    getAttribute: function (
      property: MemberPropertyNames
    ): any {
      let self = this;
      return {
