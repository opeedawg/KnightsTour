<!--
* Component: DifficultyLevelFieldsComponent
* Location:  src\entities\DifficultyLevel\components\
* 
* Renders fields related to the @see DifficultyLevel class.
* - Note: fields are rendered based on rules defined in the @see DifficultyLevelConfig class.
* 
...
<template>
  ...
  >
    ...
    <q-card-section class="q-pt-none">
  	   ...
  	   <TextField v-if="fieldsLoaded" v-bind="attr_DifficultyLevelId"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_Name"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_Description"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_MaximumGap"></TextField>
  	   <TextField v-if="fieldsLoaded" v-bind="attr_PercentVisibility"></TextField>
    </q-card-section>
  </q-card>
  <q-card
...
<script lang="ts">
  ...
  import { DifficultyLevelDBFields } from '../models/base/DifficultyLevelConfigBase';
  import { DifficultyLevelPropertyNames } from '../models/base/DifficultyLevelBase';
  import { DXResponse } from 'src/common/models/dxterity';
  import { 
    FieldConfiguration,
    FieldSupport,
  } from 'src/common/models/fieldConfiguration';
  import { fieldConfigurations } from '../models/DifficultyLevelConfig';
...
*/
export default {
  Name: 'DifficultyLevelFieldsComponent',
  ...
  data: function () {
    return {
      ...
      difficultyLevelPropertyNames: DifficultyLevelPropertyNames,
      /** Field configurations for the @see DifficultyLevel. */
      fieldConfigurations,
  ...
  computed: {
    /**
    * Computed function [attr_Description] for variable attr_Description: 
    * - Assigns the attribute collection for the Description property for field binding.
    * @returns {any} Anything
    */
    attr_Description: function attr_Description(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.difficultyLevelPropertyNames.description);
    }, // attr_Description

    /**
    * Computed function [attr_DifficultyLevelId] for variable attr_DifficultyLevelId: 
    * - Assigns the attribute collection for the DifficultyLevelId property for field binding.
    * @returns {any} Anything
    */
    attr_DifficultyLevelId: function attr_DifficultyLevelId(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.difficultyLevelPropertyNames.difficultyLevelId);
    }, // attr_DifficultyLevelId
    ...
    */
    attr_InstanceLabel: function attr_InstanceLabel(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.difficultyLevelPropertyNames.instanceLabel);
    }, // attr_InstanceLabel

    /**
    * Computed function [attr_MaximumGap] for variable attr_MaximumGap: 
    * - Assigns the attribute collection for the MaximumGap property for field binding.
    * @returns {any} Anything
    */
    attr_MaximumGap: function attr_MaximumGap(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.difficultyLevelPropertyNames.maximumGap);
    }, // attr_MaximumGap
    ...
    */
    attr_Name: function attr_Name(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.difficultyLevelPropertyNames.name);
    }, // attr_Name

    /**
    * Computed function [attr_PercentVisibility] for variable attr_PercentVisibility: 
    * - Assigns the attribute collection for the PercentVisibility property for field binding.
    * @returns {any} Anything
    */
    attr_PercentVisibility: function attr_PercentVisibility(): any {
      this.refreshAttributeTotal;
      return this.getAttribute(this.difficultyLevelPropertyNames.percentVisibility);
    }, // attr_PercentVisibility
  ...
  methods: {
    ...
    * @returns {DifficultyLevel} @see DifficultyLevel
    */
    collectFormData: function (): DifficultyLevel {
      var updatedEntity = new DifficultyLevel();
      let self = this;

      this.fieldSupport.updateEntity(
        updatedEntity,
        DifficultyLevelDBFields,
