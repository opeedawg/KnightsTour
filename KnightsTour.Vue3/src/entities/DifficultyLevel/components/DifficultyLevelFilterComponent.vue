<!--
* Component: DifficultyLevelFilterComponent
* Location:  src\entities\DifficultyLevel\components\
* 
* Renders filter fields related to the @see DifficultyLevel class.
* - Note: The filter fields are configured in @see DifficultyLevelConfig class.
* 
...
*/
export default {
  Name: 'DifficultyLevelFilterComponent',
  ...
  props: {
    /** The collection of @see DifficultyLevel to filter. */
    entities: {
      type: Array as PropType<DifficultyLevel[]>,
      required: true,
    },
  },
  ...
  methods: {
    ...
    * @param {DifficultyLevelPropertyNames} property: The property name for which to retrieve the attribute settings.
    * @returns {any} Dynamic object of attributes to bind to the control.
    */
    getAttribute: function (
      property: DifficultyLevelPropertyNames
    ): any {
      let self = this;
      return {
