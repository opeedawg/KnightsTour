<!--
* Component: DifficultyLevelEditPage
* Location:  src\entities\DifficultyLevel\pages\
* 
* The page displayed when editing an existing @see DifficultyLevel.
    ...
    processFieldsAction: function (
      ...
      if (args.action == this.projectSettings.updateActionName) {
        try {
          ...
          this.difficultylevelStore.update(args.data).then((response) => {
            if (response.isValid) {
              ...
              this.entity = <DifficultyLevel>response.dataObject;
              this.entityLoaded = true;
            } else {
