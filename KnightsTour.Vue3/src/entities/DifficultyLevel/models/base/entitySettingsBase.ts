 ...
 * The entity settings for the DifficultyLevel class that stay in sync with the DXterity model.
 * 
...
*
* Class to define all the possible entity settings for the DifficultyLevel class.  Stays in sync with the model on regeneration.  Add or overwrite in @see EntitySettings.
*
...
export abstract class EntitySettingsBase extends CommonEntitySettings implements IEntitySettings {
  ...
  */
  constructor() {
    ...
    this.className = 'DifficultyLevel';
    ...
    this.primaryKey = 'DifficultyLevelId';
    this.primaryKeyDB = 'DifficultyLevelId';
