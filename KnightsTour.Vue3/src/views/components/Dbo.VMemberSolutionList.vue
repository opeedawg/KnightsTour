<!--
* Component: Dbo.VMemberSolutionList
* Location:  src\views\components\
* 
* The class that represents a compoenent to retrieve and list data from view dbo.V_MemberSolution.
* 
...
<script lang="ts">
  ...
  import { Dbo.VMemberSolution } from 'src/views/models/extended/Dbo.VMemberSolution';
...
const columns = [
  {
    ...
    required: true,
    label: 'Puzzle id',
    field: (row: Dbo.VMemberSolution) => row.puzzleId,
    sortable: true,
  },
  {
    name: 'MemberId',
    required: false,
    label: 'Member id',
    field: (row: Dbo.VMemberSolution) => row.memberId,
    sortable: true,
  },
  {
    name: 'SolutionId',
    required: false,
    label: 'Solution id',
    field: (row: Dbo.VMemberSolution) => row.solutionId,
    sortable: true,
  },
  {
    name: 'Rows',
    required: false,
    label: 'Row',
    field: (row: Dbo.VMemberSolution) => row.rows,
    sortable: true,
  },
  {
    name: 'Cols',
    required: false,
    label: 'Col',
    field: (row: Dbo.VMemberSolution) => row.cols,
    sortable: true,
  },
  {
    ...
    field: (row: Dbo.VMemberSolution) => row.solutionDuration,
    sortable: true,
  },
  {
    ...
    field: (row: Dbo.VMemberSolution) => row.solutionStartDate,
    sortable: true,
  },
  {
    name: 'Difficulty',
    required: false,
    label: 'Difficulty',
    field: (row: Dbo.VMemberSolution) => row.difficulty,
    sortable: true,
  },
  {
    ...
    field: (row: Dbo.VMemberSolution) => row.puzzleOfTheDayDate,
    sortable: true,
  },
];

/** The definition of the rows element to be bound to the table. */
const rows = [] as Dbo.VMemberSolution[];
/** Component: Dbo.VMemberSolutionList
* - The class that represents a compoenent to retrieve and list data from view dbo.V_MemberSolution.
*/
export default {
  Name: 'Dbo.VMemberSolutionList',
  ...
  mounted: function () {
    ...
    this.baseStore
      .getView(ViewEnum.DboVMemberSolution, listFilter, true)
