<!--
* Component: DboVMemberSolutionList
...
<script lang="ts">
  ...
  import { DboVMemberSolution } from 'src/views/models/extended/DboVMemberSolution';
...
const columns = [
  {
    ...
    required: true,
    label: 'Puzzle id',
    field: (row: DboVMemberSolution) => row.puzzleId,
    sortable: true,
  },
  {
    name: 'MemberId',
    required: false,
    label: 'Member id',
    field: (row: DboVMemberSolution) => row.memberId,
    sortable: true,
  },
  {
    name: 'SolutionId',
    required: false,
    label: 'Solution id',
    field: (row: DboVMemberSolution) => row.solutionId,
    sortable: true,
  },
  {
    name: 'Rows',
    required: false,
    label: 'Row',
    field: (row: DboVMemberSolution) => row.rows,
    sortable: true,
  },
  {
    name: 'Cols',
    required: false,
    label: 'Col',
    field: (row: DboVMemberSolution) => row.cols,
    sortable: true,
  },
  {
    ...
    field: (row: DboVMemberSolution) => row.solutionDuration,
    sortable: true,
  },
  {
    ...
    field: (row: DboVMemberSolution) => row.solutionStartDate,
    sortable: true,
  },
  {
    name: 'Difficulty',
    required: false,
    label: 'Difficulty',
    field: (row: DboVMemberSolution) => row.difficulty,
    sortable: true,
  },
  {
    ...
    field: (row: DboVMemberSolution) => row.puzzleOfTheDayDate,
    sortable: true,
  },
];

/** The definition of the rows element to be bound to the table. */
const rows = [] as DboVMemberSolution[];
/** Component: DboVMemberSolutionList
* - The class that represents a compoenent to retrieve and list data from view dbo.V_MemberSolution.
*/
export default {
  Name: 'DboVMemberSolutionList',
