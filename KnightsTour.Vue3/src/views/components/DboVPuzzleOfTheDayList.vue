<!--
* Component: DboVPuzzleOfTheDayList
...
<script lang="ts">
  ...
  import { DboVPuzzleOfTheDay } from 'src/views/models/extended/DboVPuzzleOfTheDay';
...
const columns = [
  {
    ...
    required: true,
    label: 'Puzzle id',
    field: (row: DboVPuzzleOfTheDay) => row.puzzleId,
    sortable: true,
  },
  {
    ...
    field: (row: DboVPuzzleOfTheDay) => row.puzzleOfTheDayDate,
    sortable: true,
  },
  {
    ...
    field: (row: DboVPuzzleOfTheDay) => row.difficultyLevel,
    sortable: true,
  },
  {
    name: 'Rows',
    required: false,
    label: 'Row',
    field: (row: DboVPuzzleOfTheDay) => row.rows,
    sortable: true,
  },
  {
    name: 'Cols',
    required: false,
    label: 'Col',
    field: (row: DboVPuzzleOfTheDay) => row.cols,
    sortable: true,
  },
  {
    name: 'PuzzlePath',
    required: false,
    label: 'Puzzle path',
    field: (row: DboVPuzzleOfTheDay) => row.puzzlePath,
    sortable: true,
  },
  {
    name: 'BoardPath',
    required: false,
    label: 'Board path',
    field: (row: DboVPuzzleOfTheDay) => row.boardPath,
    sortable: true,
  },
  {
    name: 'DiscoveryDate',
    ...
    field: (row: DboVPuzzleOfTheDay) => row.discoveryDate,
    sortable: true,
  },
  {
    name: 'Author',
    required: false,
    label: 'Author',
    field: (row: DboVPuzzleOfTheDay) => row.author,
    sortable: true,
  },
  {
    ...
    field: (row: DboVPuzzleOfTheDay) => row.discoveryIterationCount,
    sortable: true,
  },
  {
    name: 'PuzzleCode',
    required: false,
    label: 'Puzzle code',
    field: (row: DboVPuzzleOfTheDay) => row.puzzleCode,
    sortable: true,
  },
  {
    ...
    field: (row: DboVPuzzleOfTheDay) => row.difficultyLevelId,
    sortable: true,
  },
];

/** The definition of the rows element to be bound to the table. */
const rows = [] as DboVPuzzleOfTheDay[];
/** Component: DboVPuzzleOfTheDayList
* - The class that represents a compoenent to retrieve and list data from view dbo.V_PuzzleOfTheDay.
*/
export default {
  Name: 'DboVPuzzleOfTheDayList',
