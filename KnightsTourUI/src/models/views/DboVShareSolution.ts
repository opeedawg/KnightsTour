...
/**
 * Class: DboVShareSolution
 *
 * Base class to define the @see DboVShareSolution model. It is highly recommended NOT to modify this class, it will be overwritten to stay in sync with the model.  You can overwrite or extend the functionality in the provided class - @see DboVShareSolutionBase.
 *
 * @implements {constructor} The constructor for the @see DboVShareSolution class
 */
export class DboVShareSolution {
  // *** Declarations ***
   ...
   * The constructor for the @see DboVShareSolution class
   */
  constructor() {
    this.code = '';
    this.memberName = '';
