...
import { DboVPuzzleOfTheDaySolution } from './DboVPuzzleOfTheDaySolution';
 ...
 */
export class DboVPuzzleOfTheDay {
  // *** Declarations ***
  ...
  puzzleDayFormatted: string;
  memberSolution: DboVPuzzleOfTheDaySolution | null;
  puzzleCells: number[][];
  rowIndexes: number[];
  colIndexes: number[];
  ...
  constructor() {
    ...
    this.puzzleDayFormatted = '';
    this.memberSolution = null;
    this.puzzleCells = [];
    this.rowIndexes = [];
    this.colIndexes = [];
  } // constructor
